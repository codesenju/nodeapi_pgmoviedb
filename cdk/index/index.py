...
class IndexStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        index_container = index_task_definition.add_container(
           ...
           image=ecs.ContainerImage.from_registry("codesenju/index.api.local:amd"),
        ...
        cdk.CfnOutput(self,"indexServiceArn",value=index_service.service_arn,export_name="indexServiceArn")
